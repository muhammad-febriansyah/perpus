...
$sqldetil = $this->db->query("select peminjaman.*,siswa.nis,siswa.kelas from peminjaman left join siswa on siswa.nama = peminjaman.siswa where peminjaman.siswa='$siswa'");
//body

$pdf->SetFont('Times', 'B', 14);
$pdf->Cell(0, 5, 'Laporan Data Peminjaman & Pengembalian Buku Siswa', 0, 1, 'C');
$pdf->Cell(30, 8, '', 0, 1);
...
foreach ($sqldetil->result() as $d) {
    ...
    $pdf->Cell(30, 6, ($d->status == "Pinjam") ? "Sedang Dipinjam" : "Sudah Dikembalikan", 1, 0);
